...
{
    public partial class DanhMucView : BaseDictionaryView
    {
        IDanhMucViewModel _vm = Config.Container.Resolve<IDanhMucViewModel>();
        public DanhMucView()
        {
            InitializeComponent();
            ...
            btnAdd.ItemClick += delegate { _vm.AddCommand.Execute(); MaDanhMucTextEdit.Focus(); };
