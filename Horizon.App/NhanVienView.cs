...
{
    public partial class NhanVienView : BaseDictionaryView
    {
        INhanVienViewModel _vm = Config.Container.Resolve<INhanVienViewModel>();
        public NhanVienView()
        {
            InitializeComponent();
            ...
            btnAdd.ItemClick += delegate { _vm.AddCommand.Execute(); MaNhanVienTextEdit.Focus(); };
