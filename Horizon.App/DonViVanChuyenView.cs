...
{
    public partial class DonViVanChuyenView : BaseDictionaryView
    {
        IDonViVanChuyenViewModel _vm = Config.Container.Resolve<IDonViVanChuyenViewModel>();
        public DonViVanChuyenView()
        {
            InitializeComponent();
            ...
            btnAdd.ItemClick += delegate { _vm.AddCommand.Execute(); MaDonViVanChuyenTextEdit.Focus(); };
